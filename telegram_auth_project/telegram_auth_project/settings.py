...
SECRET_KEY = 'django-insecure-p&xsufcu7+1*ke^-9gs*c4sq0r7r!*o25mt**p9jji6@va=%js'
...
SESSION_COOKIE_SECURE = False  # Убедитесь, что это False, если вы не используете HTTPS
